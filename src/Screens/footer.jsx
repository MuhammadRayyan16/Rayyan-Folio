        ...
        <>
            ...
            <div className="footer">
                ...
                <div className="footer-section">
                    <h3>Design</h3>
                    <p>
                        Inspired by <a href="https://rayyanfolio.netlify.app/" target="_blank" rel="noopener noreferrer">Muhammad Rayyan</a>'s website.
                    </p>
                </div>
                <div className="footer-section">
                    <h3>Social</h3>
                    <div className="social-icons">
                        ...
                        <a href="https://www.linkedin.com/in/muhammad-rayyan11/" target="_blank" rel="noopener noreferrer">
